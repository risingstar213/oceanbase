...
private:
  ...
  int create_schemas_add_columns_insert_memtable(uint64_t tenant_id, ObIArray<ObTableSchema*> &table_schemas, ObTableSchema* schema, ObTableSchema* history_schema);
